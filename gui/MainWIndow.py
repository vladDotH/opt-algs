...
class MainWindow(QMainWindow):
    ...
    def onInfo(self) -> None:
        msg = '''
В поле функции введите аналитически заданную функцию, к которой будет применён выбранный метод оптимизации с выбранными параметрами. 
Например x**4 - 2*x**3 - 2*x**2 + 2*x + 4 , где ** - возведение в степень, а * - умножение.
